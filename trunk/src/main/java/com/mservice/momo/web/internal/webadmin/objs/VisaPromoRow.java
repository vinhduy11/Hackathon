...
/**
 * Created by concu on 6/22/15.
 */
public class VisaPromoRow {
    ...
    public String cashinTime = "";
    public String error = "";
    public String errorDesc = "";

    public VisaPromoRow(String rawRow) {
        ...
        cashinTime = fields.length > 6 ? fields[6].trim() : "";
    ...
    public JsonObject toJson() {
        ...
        jo.putString(VisaMpointPromoConst.CASHIN_TIME, cashinTime);
