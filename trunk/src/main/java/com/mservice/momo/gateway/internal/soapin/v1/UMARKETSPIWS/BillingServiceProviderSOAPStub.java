/**
 * BillingServiceProviderSOAPStub.java
 *
...
public class BillingServiceProviderSOAPStub extends org.apache.axis.client.Stub implements BillingService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "payBill"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "PayBillRequest"), PayBillRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "PayBillResponse"));
        oper.setReturnClass(PayBillResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "payBillResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("isBillAccountValid");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "isBillAccountValid"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "IsBillAccountValidRequest"), IsBillAccountValidRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "IsBillAccountValidResponse"));
        oper.setReturnClass(IsBillAccountValidResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "isBillAccountValidResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
    ...
    public BillingServiceProviderSOAPStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BillingServiceProviderSOAPStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BillingServiceProviderSOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = IsAirtimeAccountValidRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = IsAirtimeAccountValidResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public PayBillResponse payBill(PayBillRequest payBillRequest) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BillingServiceProvider/PayBill");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "payBill"));

        setRequestHeaders(_call);
        setAttachments(_call);
         try {        Object _resp = _call.invoke(new Object[] {payBillRequest});
                ...
                if (_resp instanceof java.rmi.RemoteException) {
                    ...
                    try {
                        return (PayBillResponse) _resp;
                    } catch (Exception _exception) {
                        return (PayBillResponse) org.apache.axis.utils.JavaUtils.convert(_resp, PayBillResponse.class);
                    }
                }
    ...
    public IsBillAccountValidResponse isBillAccountValid(IsBillAccountValidRequest isBillAccountValidRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BillingServiceProvider/IsBillAccountValid");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "isBillAccountValid"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {isBillAccountValidRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (IsBillAccountValidResponse) _resp;
            } catch (Exception _exception) {
                return (IsBillAccountValidResponse) org.apache.axis.utils.JavaUtils.convert(_resp, IsBillAccountValidResponse.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public ReverseResponse reverse(ReverseRequest reverseRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BillingServiceProvider/Reverse");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        Object _resp = _call.invoke(new Object[] {reverseRequest});
  ...
  throw axisFaultException;
    ...
    public CommitResponse commit(CommitRequest commitRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BillingServiceProvider/Commit");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        Object _resp = _call.invoke(new Object[] {commitRequest});
  ...
  throw axisFaultException;
    ...
    public RollbackResponse rollback(RollbackRequest rollbackRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BillingServiceProvider/Rollback");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
