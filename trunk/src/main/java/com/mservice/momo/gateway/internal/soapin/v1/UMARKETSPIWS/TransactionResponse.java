...
public abstract class TransactionResponse  extends ServiceResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the serviceTransactionId value for this TransactionResponse.
     * 
    ...
    /**
     * Sets the serviceTransactionId value for this TransactionResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "TransactionResponse"));
