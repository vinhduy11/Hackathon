/**
 * NotificationReceiverSOAPStub.java
 *
...
public class NotificationReceiverSOAPStub extends org.apache.axis.client.Stub implements NotificationReceiver {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("notify");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "notify"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "NotifyRequest"), NotifyRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "NotifyResponse"));
        oper.setReturnClass(NotifyResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "notifyResponse"));
    ...
    public NotificationReceiverSOAPStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public NotificationReceiverSOAPStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public NotificationReceiverSOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public NotifyResponse notify(NotifyRequest notifyRequest) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:UMARKETSPIWS/NotificationReceiver/Notify");
        _call.setEncodingStyle(null);
 ...
 try {        Object _resp = _call.invoke(new Object[] {notifyRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (NotifyResponse) _resp;
            } catch (Exception _exception) {
                return (NotifyResponse) org.apache.axis.utils.JavaUtils.convert(_resp, NotifyResponse.class);
            }
        }
