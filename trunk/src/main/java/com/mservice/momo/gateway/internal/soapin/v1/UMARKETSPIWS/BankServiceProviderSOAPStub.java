/**
 * BankServiceProviderSOAPStub.java
 *
...
public class BankServiceProviderSOAPStub extends org.apache.axis.client.Stub implements BankService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("creditBankAccount");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "creditBankAccount"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "CreditBankAccountRequest"), CreditBankAccountRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "CreditBankAccountResponse"));
        oper.setReturnClass(CreditBankAccountResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "creditBankAccountResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("debitBankAccount");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "debitBankAccount"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "DebitBankAccountRequest"), DebitBankAccountRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "DebitBankAccountResponse"));
        oper.setReturnClass(DebitBankAccountResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "debitBankAccountResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("isBankAccountValid");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "isBankAccountValid"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "IsBankAccountValidRequest"), IsBankAccountValidRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "IsBankAccountValidResponse"));
        oper.setReturnClass(IsBankAccountValidResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:UMARKETSPIWS:com.mservice.momo.gateway.internal.soapin.v1", "isBankAccountValidResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[2] = oper;
    ...
    public BankServiceProviderSOAPStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BankServiceProviderSOAPStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BankServiceProviderSOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public CreditBankAccountResponse creditBankAccount(CreditBankAccountRequest creditBankAccountRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/CreditBankAccount");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "creditBankAccount"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {creditBankAccountRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (CreditBankAccountResponse) _resp;
            } catch (Exception _exception) {
                return (CreditBankAccountResponse) org.apache.axis.utils.JavaUtils.convert(_resp, CreditBankAccountResponse.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public DebitBankAccountResponse debitBankAccount(DebitBankAccountRequest debitBankAccountRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/DebitBankAccount");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "debitBankAccount"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {debitBankAccountRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (DebitBankAccountResponse) _resp;
            } catch (Exception _exception) {
                return (DebitBankAccountResponse) org.apache.axis.utils.JavaUtils.convert(_resp, DebitBankAccountResponse.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public IsBankAccountValidResponse isBankAccountValid(IsBankAccountValidRequest isBankAccountValidRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/IsBankAccountValid");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "isBankAccountValid"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {isBankAccountValidRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (IsBankAccountValidResponse) _resp;
            } catch (Exception _exception) {
                return (IsBankAccountValidResponse) org.apache.axis.utils.JavaUtils.convert(_resp, IsBankAccountValidResponse.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public ReverseResponse reverse(ReverseRequest reverseRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/Reverse");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        Object _resp = _call.invoke(new Object[] {reverseRequest});
  ...
  throw axisFaultException;
    ...
    public CommitResponse commit(CommitRequest commitRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/Commit");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        Object _resp = _call.invoke(new Object[] {commitRequest});
  ...
  throw axisFaultException;
    ...
    public RollbackResponse rollback(RollbackRequest rollbackRequest) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:UMARKETSPIWS/BankServiceProvider/Rollback");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
